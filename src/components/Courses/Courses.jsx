                    ...
                    <Fragment>
                         <Container className="text-center">
                              ...
                              <Row>
                                   ...
                                   <Col lg={6} md={6} sm={12} className="p-2" >
                                        <Zoom top>
                                             <img className="courseImg" src={recent1} />
                                        </Zoom>
                                   </Col>

                                   <Col lg={6} md={6} sm={12}>
                                        <Zoom top>
                                             <h5 className="text-justify serviceName">Cource details  </h5>
                                             <p className="text-justify serviceDescription">Breakpoints are customizable widths that determine how your responsive layout behaves across device or viewport sizes in Bootstrap.</p> </Zoom>
                                        {/* <Link className="courseViewMore float-left" to={"/coursedetails/" + MyList.id + "/" + MyList.short_title} >View Details</Link> */}
                                   </Col>
