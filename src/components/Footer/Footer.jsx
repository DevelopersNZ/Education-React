               ...
               return (
                    <Fragment>
                              ...
                              <Row>
                                   ...
                                   <Col lg="3" md={6} sm={12} className="p-5 text-justify" >
                                        ...
                                        <p className="footerDescription">
                                             17 Awater Street, Clover park, Manukau, Auckland <br></br>
                                             <FontAwesomeIcon icon={faEnvelope} /> Email : gyathursan@gmail.com<br></br>
                                             <FontAwesomeIcon icon={faPhone} /> Phone : 0223672717<br></br>
                                        </p>
                                   </Col>
                                   <Col lg="3" md={6} sm={12} className="p-5 text-justify">
                         ...
                         <Container fluid={true} className="text-center copyrightSection">
                              <a className="copyrightlink" href="#">React-Bootstrap replaces the Bootstrap JavaScript.</a>
                         </Container>
                    </Fragment>
               )
